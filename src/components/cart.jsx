...
const Cart = (props) => {
    const { data, videos, setData } = props
    ...
    return (
        <main  style={{background: "#525E75", minHeight: "calc(100vh - 175px)"}}>
            <div style={{position: "relative", background: "#525E75"}}>
                <Typography style={{color: "#F1DDBF", textAlign: "center", fontSize: "50px",
                    paddingBottom: "30px", marginLeft: "-50px", textShadow: "4px 4px 2px rgba(0,0,0,0.6)"}} >Your Cart 
                    <ShoppingCartIcon style={{ marginLeft: "15px", position: "absolute", top: "10%", fontSize: "60px",
                    textShadow: "4px 4px 2px rgba(0,0,0,0.6)"}}></ShoppingCartIcon></Typography>
            </div>
            <div className='cart'>
                ...
                <div style={{height: "100%", position: "sticky", display: "flex", flexDirection: 'column', top: '0'}}>
                    ...
                    <Typography variant="h2" style={{color: "#F1DDBF", marginTop: "100px", textShadow: "4px 4px 2px rgba(0,0,0,0.6)", 
                        fontSize: "25px"}}>Total: $<Typography style={{display: "inline", fontWeight: "400", fontSize: "25px"}}>
                            {data.reduce((accumulator, video) => {
                                if (video.isInCart){
